...
init() ->
	...
	State = #state{
		red_spawn_points=[
			#vec{x=1650, y=0.5,z=125},
			#vec{x=1425, y=0.5,z=125},
			#vec{x=1165, y=0.5,z=80},
			#vec{x=625, y=0.5,z=80},
			#vec{x=415, y=0.5,z=85},
			#vec{x=100, y=0.5,z=50},
			#vec{x=890, y=0.5,z=80},
			#vec{x=1875, y=0.5,z=130}
		],
		blue_spawn_points=[
			#vec{x=125, y=0.5,z=1875},
			#vec{x=375, y=0.5,z=1850},
			#vec{x=625, y=0.5,z=1850},
			#vec{x=850, y=0.5,z=1875},
			#vec{x=1125, y=0.5,z=1875},
			#vec{x=1375, y=0.5,z=1875},
			#vec{x=1650, y=0.5,z=1875},
			#vec{x=1375, y=0.5,z=1875}
		]
	},
    {ok, State}.
